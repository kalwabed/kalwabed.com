...
![1.1](/static/posts/notion-as-headless/table-init.png)

![1.2](/static/posts/notion-as-headless/table-structure.png)

### Step 2

We initial the data.

![Three preliminary data](/static/posts/notion-as-headless/table-initial-data.png)
...
![How to share link](/static/posts/notion-as-headless/share-link.png)
...
![Json results in the browser](/static/posts/notion-as-headless/browser-result.png)
...
![Result from SSR](/static/posts/notion-as-headless/api-result.png)
