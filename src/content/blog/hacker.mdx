...
![Factory home page](/static/posts/hacker/advanced-home.png)
...
![Factory login page](/static/posts/hacker/checked-login.png)
...
![Stranger indication](/static/posts/hacker/two-circles.png)
...
![Browser elements](/static/posts/hacker/elements.png)
...
![Browser application section](/static/posts/hacker/application.png)

In the `application`, open the Cookies section, and click the url address that is there.

Look at the picture below

![Flag in the cookies](/static/posts/hacker/cookie-url.png)
...
![Set admin cookies to true](/static/posts/hacker/admin-true.png)
...
![Flag appeared](/static/posts/hacker/picoctf.png)
