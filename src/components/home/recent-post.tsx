...
const RecentPost: React.FC<{
  ...
  return (
    <Link
      href={`/blog/${slug}`}
      className="w-full flex items-center space-x-3 md:space-x-10 lg:space-x-12 p-3 transition rounded-sm focus:ring focus:ring-link outline-none hover:bg-subtleAppBg focus:bg-subtleAppBg"
    >
      <time
