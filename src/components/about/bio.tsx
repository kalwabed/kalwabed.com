  ...
  return (
    <div className="text-lowContrast w-full md:w-11/12 lg:w-10/12 tracking-wider">
      ...
      <div className="space-y-8">
        <Divider isCenter />
        <p>
          Day-to-day I work full-time at VNT Networks as a full-stack developer. I&apos;m also an undergraduate student
          of Informatics at Amikom University, Yogyakarta. Outside of my job, I like to make things out of the ideas
          that pop into my head. I&apos;ll probably put it later on the <TextLink href="/projects">projects</TextLink>{' '}
