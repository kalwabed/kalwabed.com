...
isFeatured: false
title: 'NAM Logistic'
status: 'Periodic maintenance'
banner: '/static/projects/namlogistic/banner.png'
liveUrl: 'https://namlogistic.co.id'
githubRepo: ''
publishedAt: '2020-12-30'
techs: ['React', 'Next', 'Chakra UI']
description: 'Company profile website for inter-island logistics service providers in Indonesia.'
summary: 'NAM Logistic is a project ordered by a logistics service company to answer problems, such as: seeing cost estimates, and travel routes. In addition, to improve the quality of service and customer trust with an official website.'
---
