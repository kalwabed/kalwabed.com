...
<JustImages height={850} images={['/static/posts/reduce-bundle-size/before.png']} label="Vercel deploy" />

After

<JustImages height={850} images={['/static/posts/reduce-bundle-size/after.png']} label="Vercel deploy" />
