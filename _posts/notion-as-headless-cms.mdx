...
<JustImages height={850} images={['/static/posts/notion-as-headless/table-init.png']} label="1.1" />

<JustImages height={850} images={['/static/posts/notion-as-headless/table-structure.png']} label="1.2" />
...
<JustImages
  height={850}
  images={['/static/posts/notion-as-headless/table-initial-data.png']}
  label="Three preliminary data"
/>
...
<JustImages height={850} images={['/static/posts/notion-as-headless/share-link.png']} label="How to share link" />
...
<JustImages
  height={850}
  images={['/static/posts/notion-as-headless/browser-result.png']}
  label="Json results in the browser"
/>
...
<JustImages height={850} images={['/static/posts/notion-as-headless/api-result.png']} label="Result from SSR" />
