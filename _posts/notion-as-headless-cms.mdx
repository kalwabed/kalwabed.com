...
<Update
  title="Update 19 August, 2021"
  content={`Currently Notion has provided facilities to developers in the form of an <a href='https://developers.notion.com'>official API</a> that we can use to access data on our Notion. In the future I recommend using the official API from Notion. <p>But you can still refer here using the Serverless Wrapper from <a href='https://github.com/splitbee/notion-api-worker'>Splitbee</a> if you need.</p>
`}
/>
...
<PostImage image={'/static/posts/notion-as-headless/table-init.png'} label="1.1" />

<PostImage image={'/static/posts/notion-as-headless/table-structure.png'} label="1.2" />

### Step 2

We initial the data.

<PostImage image={'/static/posts/notion-as-headless/table-initial-data.png'} label="Three preliminary data" />
...
<PostImage image={'/static/posts/notion-as-headless/share-link.png'} label="How to share link" />
...
<PostImage image={'/static/posts/notion-as-headless/browser-result.png'} label="Json results in the browser" />
...
<PostImage image={'/static/posts/notion-as-headless/api-result.png'} label="Result from SSR" />
